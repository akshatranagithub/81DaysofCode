...
def enter_details(entry):
    ...
    # fill out the fields
    driver.find_element(By.XPATH('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div/'
                                 'div[1]/input')).send_keys(entry["address"])
    driver.find_element(By.XPATH('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/'
                                 'div[1]/input')).send_keys(entry["price"])
    driver.find_element(By.XPATH('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div[1]/div/'
